...
CREATE INDEX IF NOT EXISTS idx_risk_score_date       ON risk_score(forecast_date);
CREATE INDEX IF NOT EXISTS idx_risk_score_level      ON risk_score(risk_level);
CREATE INDEX IF NOT EXISTS idx_history_fetched       ON weather_forecast_history(fetched_at);